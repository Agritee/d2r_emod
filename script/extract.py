...
with open('./resource/to_extract/item-names.json','r',encoding='utf-8-sig')as fp:
    my_json_data = json.load(fp)
...
with open('./table/float_value.json','w',encoding='utf-8')as fp:
    fp.write(json.dumps(float_value,ensure_ascii=False))

with open('./table/comment.json','w',encoding='utf-8')as fp:
